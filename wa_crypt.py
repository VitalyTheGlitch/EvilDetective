...
class WhatsAppCrypt(BaseWindow):
    KEY_SIZE = decryptors.WhatsAppCrypt.KEY_SIZE
    DECODED_DIR = decryptors.WhatsAppCrypt.DECODED_DIR
    DECODED_EXT = decryptors.WhatsAppCrypt.DECODED_EXT
    ...
    def __init__(self, root=None, title='WhatsApp Crypt Decryptor'):
        ...
        tk.Button(self.mainframe, textvariable=self._info_but, relief='flat', command=self.info_toggle).grid(row=1, column=2, columnspan=1, sticky=tk.E)
        ...
        try:
            ...
            for i in sel:
                ...
                if decrypter:
                    ...
                    except decryptors.WhatsAppCryptError as err:
    ...
    def get_supported(self):
        return {kls.CRYPT: kls for kls in decryptors.WhatsAppCrypt.__subclasses__()}
